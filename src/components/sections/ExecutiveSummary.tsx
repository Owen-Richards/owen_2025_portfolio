...
export function ExecutiveSummary() {
  ...
  return (
    <section className="from-primary/2 to-accent/2 relative bg-gradient-to-r via-transparent py-16">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            <div className="mb-6">
              ...
              <p
                className={`${styles.text.bodyLarge} ${styles.text.muted} leading-relaxed`}
              >
                Senior full-stack engineer with demonstrated expertise in
                scaling engineering teams and systems from startup to
                enterprise. Passionate about performance, developer experience,
          ...
          >
            <div className={`${styles.card.base} space-y-6 p-8`}>
              <div>
                <h3
                  className={`${styles.text.subheading} mb-4 flex items-center gap-2`}
                >
              ...
              <div className="border-t border-border pt-6">
                <h4 className={`${styles.text.primary} mb-3 font-semibold`}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className={styles.text.muted}>
                      Remote/Hybrid (US/EU timezone overlap)
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
